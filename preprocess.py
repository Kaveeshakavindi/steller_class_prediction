...
# since machine learing models cannot process string categorical values
# we convert each such column into numerical data
...
# robust scalar - reduce impact of outliers by scaling data and without removing outliers
